        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-white/70">
            ...
            <section>
              ...
              <p>
                This Privacy Policy explains how Tamilaga Vettri Kazhagam (TVK) Kasipalayam 
                collect, use, disclose, and safeguard your information when you visit our website at 
                <strong> tvkkasipalayam.in</strong>, including any other media form, media channel, mobile 
            ...
            <section>
              ...
              <div className="bg-neutral-900 p-4 rounded border-l-4 border-red-700">
                <p className="font-bold mb-2">TVK Kasipalayam</p>
                <p>Kasipalayam, Gobichettipalayam</p>
                <p>Erode District, Tamil Nadu 638454</p>
                <p>India</p>
                <p className="mt-3">
                  <strong>Email:</strong> <a href="mailto:contact@tvkkasipalayam.in" className="text-yellow-400 hover:text-yellow-300">contact@tvkkasipalayam.in</a>
                </p>
              </div>
            </section>
